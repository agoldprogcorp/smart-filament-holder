 ...
 * 
 * DUAL SPI VERSION:
 * - VSPI (GPIO 18, 23, 5) for LCD display
 * - HSPI (GPIO 14, 12, 13, 15) for RC522 NFC reader
 * - No SPI switching or mutex needed!
 * 
...
// SPI mutex удален - используем два независимых SPI контроллера
...
Arduino_DataBus *bus = new Arduino_ESP32SPI(LCD_DC, LCD_CS, LCD_SCK, LCD_MOSI, -1, VSPI);
