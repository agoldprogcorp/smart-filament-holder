 ...
 * ===================================
 * 
 * Программа для калибровки тензодатчика HX711.
 * Помогает найти правильный CALIBRATION_FACTOR для config.h
 * 
 * Инструкция:
 * 1. Загрузи эту программу на ESP32
 * 2. Открой Serial Monitor (115200 baud)
 * 3. Следуй инструкциям на экране
 * 4. Полученный CALIBRATION_FACTOR запиши в config.h
 */
